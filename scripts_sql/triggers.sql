...
FOR EACH ROW
BEGIN
	UPDATE videoclub.copias SET disponibilidad = 'disponible'
	WHERE id_copia = (SELECT copias_id_copia FROM videoclub.reservaciones  
	WHERE id_reservacion = NEW.reservaciones_id_reservacion);
